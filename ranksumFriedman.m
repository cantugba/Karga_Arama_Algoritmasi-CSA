...
algorithms = {'sos','csa','case_1','case_2','case_3','case_4','case_5','case_6','case_7','case_8','case_9','case_10','case_11','case_12','case_13','case_14','case_15','case_16','FDB_Pop','FDB_PopArtnDu','FDB_PopDinamik'};

algorithmsNumber = length(algorithms); functionsNumber = 10; experimentNumber = 1; 
experimentsName = {'Cec2020', 'Mean'};
filename = 'Sonuclar.xlsx'; run = 25;
...
for i = 1 : functionsNumber
    for j = 1 : experimentNumber
        fridmanRes(j, i, :) = friedmanR(experimentNumber * (i - 1) + j, :);
    end
end
for i = 1 : algorithmsNumber
    for j = 1 : experimentNumber
