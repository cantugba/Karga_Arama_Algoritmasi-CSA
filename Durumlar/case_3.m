function [bestSolution, bestFitness, iteration]=case_3(fhd, dimension, maxIteration, fNumber)
...
for t=1:tmax
    ...
    for i=1:N % Update position and memory
        if xnew(i,:)>=l & xnew(i,:)<=u
            ...
            if rand < 0.1
%             FddbPopDinamik( population, fitness, XoldIndex, Xnew, XNewFitnes, maxIteration, iter)
