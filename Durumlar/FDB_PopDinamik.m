function [bestSolution, bestFitness, iteration]=FDB_PopDinamik(fhd, dimension, maxIteration, fNumber)
...
for t=1:tmax
    ...
    for i=1:N % Update position and memory
        if xnew(i,:)>=l & xnew(i,:)<=u
            ...
            % sadece FdbPopArtnDu( Populasyon, Fitnes, XoldIndex, Xnew, XNewFitnes, maxIteration, iter )
